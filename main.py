...
def parse_args():
    ...
    parser.add_argument('--input', type=str, default='/media/cvpr-pu/4TB_1/sungho1/ban-vp-vqatest/saved_models/gender_fusion_notsignoid_1111/model_epoch11.pth')
    parser.add_argument('--output', type=str, default='saved_models/retest')
...
if __name__ == '__main__':
    ...
    if args.task == 'vqa':
        from gender_fusion_train import train
    ...
    model = getattr(gender_fusion_model, constructor)(train_dset, args.num_hid, args.op, args.gamma, args.task).cuda()
